...
- (void)testIsDirty
{
    ...
    //Check if the first document returned is dirty
    BOOL isDirty = [people isDirtyWithDocumentId:1 error:nil];
    
    XCTAssertTrue(isDirty, @"check isDirty result");
}
