...
- (void)testFileInfo
{
    ...
    //TIP: Set a breakpoint in the assertion below and look at the value inside the results NSArray above.
    XCTAssertTrue(results.count == 1, @"check file info result count");
}
