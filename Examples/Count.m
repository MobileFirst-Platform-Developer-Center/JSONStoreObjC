...
- (void)testCount
{
    ...
    //Count all.
    int countAllResult = [[people countAllDocumentsAndReturnError:nil] intValue];
    
    XCTAssertTrue(countAllResult == 2, @"check count all result");
    ...
    int countWithQueryPartResult = [[people countWithQueryParts:@[queryPart1] error:nil] intValue];
    
    XCTAssertTrue(countWithQueryPartResult == 1, @"check count with query part result");
}
