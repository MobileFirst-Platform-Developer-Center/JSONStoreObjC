...
/**
 * Pins the server's public key to the client. Once you call this method, 
 * the client will be able to make connect requests to only the server that contains the specified certificate.
